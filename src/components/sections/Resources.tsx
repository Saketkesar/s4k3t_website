  ...
  if (loading) {
    return (
      <div className="flex items-center justify-center min-h-[400px]">
        <div className="text-gray-600 font-mono text-sm">Loading resources...</div>
      </div>
    );
  }
      ...
      <div className="space-y-6">
        ...
        <div className="border border-gray-300 bg-white p-6">
          <div className="flex items-center space-x-2 mb-4 font-mono">
            ...
            <h1 className="text-lg font-bold text-gray-800">{currentResource.title}</h1>
          </div>
  ...
  return (
    <div className="space-y-6">
      <div className="space-y-2">
        <h2 className="text-xl font-mono font-bold text-gray-800">Resources</h2>
        <p className="text-gray-600 font-mono text-sm">Organized notes and tools</p>
      </div>
          ...
          >
            <div className="flex items-start space-x-3">
              ...
              <div className="space-y-1">
                <h3 className="text-gray-800 font-mono text-sm font-semibold">{resource.title}</h3>
                <p className="text-gray-600 text-xs leading-relaxed font-mono">{resource.description}</p>
              </div>
            </div>
          </div>
        ))}
